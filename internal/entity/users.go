...
type User struct {
	...
	StripeCustomerID null.String `boil:"stripe_customer_id" json:"stripe_customer_id,omitempty" toml:"stripe_customer_id" yaml:"stripe_customer_id,omitempty"`
...
var UserWhere = struct {
	...
	StripeCustomerID: whereHelpernull_String{field: "\"users\".\"stripe_customer_id\""},
...
func (r *userR) GetPaymentTransactions() PaymentTransactionSlice {
	if r == nil {
		return nil
	}
...
var (
	userAllColumns            = []string{"id", "email", "password_hash", "stripe_customer_id", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"email", "password_hash"}
	userColumnsWithDefault    = []string{"id", "stripe_customer_id", "created_at", "updated_at"}
...
func (o *User) PaymentTransactions(mods ...qm.QueryMod) paymentTransactionQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"payment_transactions\".\"user_id\"=?", o.ID),
	)
...
func (userL) LoadPaymentTransactions(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		...
		qm.WhereIn(`payment_transactions.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *User) AddPaymentTransactions(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*PaymentTransaction) error {
	var err error
