...
type Subscription struct {
	...
	StripeSubscriptionID string    `boil:"stripe_subscription_id" json:"stripe_subscription_id" toml:"stripe_subscription_id" yaml:"stripe_subscription_id"`
	Status               string    `boil:"status" json:"status" toml:"status" yaml:"status"`
	TrialStart           null.Time `boil:"trial_start" json:"trial_start,omitempty" toml:"trial_start" yaml:"trial_start,omitempty"`
	TrialEnd             null.Time `boil:"trial_end" json:"trial_end,omitempty" toml:"trial_end" yaml:"trial_end,omitempty"`
...
var SubscriptionTableColumns = struct {
	...
	TrialStart:           "subscriptions.trial_start",
	TrialEnd:             "subscriptions.trial_end",
	StartedAt:            "subscriptions.started_at",
...
var SubscriptionWhere = struct {
	...
	StripeSubscriptionID whereHelperstring
	Status               whereHelperstring
	TrialStart           whereHelpernull_Time
	TrialEnd             whereHelpernull_Time
	...
	StripeSubscriptionID: whereHelperstring{field: "\"subscriptions\".\"stripe_subscription_id\""},
	Status:               whereHelperstring{field: "\"subscriptions\".\"status\""},
	TrialStart:           whereHelpernull_Time{field: "\"subscriptions\".\"trial_start\""},
	TrialEnd:             whereHelpernull_Time{field: "\"subscriptions\".\"trial_end\""},
	StartedAt:            whereHelpernull_Time{field: "\"subscriptions\".\"started_at\""},
...
var (
	subscriptionAllColumns            = []string{"id", "user_id", "stripe_subscription_id", "status", "trial_start", "trial_end", "started_at", "next_billing_date", "created_at", "updated_at"}
	subscriptionColumnsWithoutDefault = []string{"user_id", "stripe_subscription_id", "status"}
	subscriptionColumnsWithDefault    = []string{"id", "trial_start", "trial_end", "started_at", "next_billing_date", "created_at", "updated_at"}
...
func (q subscriptionQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Subscription, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "entity: failed to execute a one query for subscriptions")
	}
...
func (q subscriptionQuery) All(ctx context.Context, exec boil.ContextExecutor) (SubscriptionSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "entity: failed to assign all query results to Subscription slice")
	}
...
func (q subscriptionQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to count subscriptions rows")
	}
...
func (q subscriptionQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "entity: failed to check if subscriptions exists")
	}
...
func FindSubscription(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*Subscription, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "entity: unable to select from subscriptions")
	}
...
func (o *Subscription) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("entity: no subscriptions provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to insert into subscriptions")
	}
...
func (o *Subscription) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("entity: unable to update subscriptions, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update subscriptions row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by update for subscriptions")
	}
...
func (q subscriptionQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update all for subscriptions")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to retrieve rows affected for subscriptions")
	}
...
func (o SubscriptionSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update all in subscription slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to retrieve rows affected all in update all subscription")
	}
	return rowsAff, nil
}
...
func (o *Subscription) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("entity: no subscriptions provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("entity: unable to upsert subscriptions, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(subscriptionPrimaryKeyColumns) == 0 {
				return errors.New("entity: unable to upsert subscriptions, could not build conflict column list")
			}
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to upsert subscriptions")
	}
...
func (o *Subscription) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("entity: no Subscription provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete from subscriptions")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by delete for subscriptions")
	}
...
func (q subscriptionQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("entity: no subscriptionQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete all from subscriptions")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by deleteall for subscriptions")
	}
...
func (o SubscriptionSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete all from subscription slice")
	}
...
func (o *SubscriptionSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to reload all in SubscriptionSlice")
	}
...
func SubscriptionExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "entity: unable to check if subscriptions exists")
	}
